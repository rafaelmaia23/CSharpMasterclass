...
namespace TicketsDataAggregator.TicketsAggregatorApp;
...
internal class TicketsAggregator
{
    ...
    {
        var split = document.Split(new[] { "Title:", "Date:", "Time:", "Visit us:" },
    ...
    private static string BuildTicketData(string[] split, int i, CultureInfo ticketCulture)
    {
        ...
        var tickectData = $"{title,-40}|{dateAsStringInvariant}|{timeAsStringInvariant}";
        return tickectData;
    }    
}
